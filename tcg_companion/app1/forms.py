...
def validateName(name):
    for char in name:
        if char.isdigit():
            raise forms.ValidationError("Card/set name cannot contain any numbers.")
...
class SearchCardForm(forms.Form):
    card_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"placeholder": "Pikachu", "style": "font-size:small"}
        ),
        validators=[
    ...
    set_name = forms.CharField(
        ...
        max_length=50,
        widget=forms.TextInput(
            attrs={"placeholder": "Base", "style": "font-size:small"}
        ),
        validators=[
